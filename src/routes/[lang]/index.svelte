...
<div class="max-w-6xl mx-auto bg-white shadow-lg relative z-20 hidden md:block"
    ...
    <!--	<div class="h-5 w-5 rounded-full bg-blue-500 absolute top-0 left-0 -ml-32 mt-12"-->
    <!--			style="z-index: -1;">-->
    <!--	</div>-->
        ...
        <div class="bg-green-600 border rounded shadow p-2">
            <div class="flex flex-row items-center">
                ...
                <div class="flex-1 text-right">
                    ...
                    <h3 class="text-white text-3xl">13.249<span class="text-green-400"><i class="fas fa-caret-down"></i></span>
                    </h3>
                </div>
            </div>
        </div>
