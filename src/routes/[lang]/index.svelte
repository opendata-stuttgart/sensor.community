    ...
    <div class="px-4 py-16">
        <div class="relative md:max-w-2xl md:mx-auto text-center">
            <h1 class="font-bold text-gray-700 text-xl md:text-4xl leading-tight mb-6">
                <a class="bg-teal-500 text-white px-2 hover:text-teal-800" href="{$locale}/docs/">{$_('index.h1-build')}</a> {$_('index.h1-become')}<a class="bg-yellow-500 text-white px-2 hover:text-yellow-700" href="{$locale}/community">{$_('index.h1-civic-tech')}</a>{$_('index.h1-support')} <a class="bg-blue-300 text-white px-2 hover:text-blue-700" href="{$locale}/contributors">{$_('index.h1-contributors')}</a>
            </h1>
        </div>
    </div>
</section>
                ...
                <div>
                    <div class="rounded flex justify-center items-center">
                        <div class="rounded flex justify-center items-center p-3">
                            <a href="http://stats.sensor.community/images/stats_active_sensors.svg" rel="prefetch" target="_blank">
                                <div class="rounded bg-gray-200 shadow-md h-48 w-48 p-6 flex flex-col justify-around hover:text-white hover:bg-teal-500">
                                        ...
                                        <p class="text-2xl text-grey-darker font-bold block font-semibold" id="number_sensors">13.249</p>
                                </div>
                            </a>
                        </div>
                        <div class="rounded flex justify-center items-center p-3">
                            <a href="http://stats.sensor.community/scripts/active_sensors.php" rel="prefetch" target="_blank">
