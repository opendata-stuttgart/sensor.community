        ...
        <div class="container mx-auto text-center">
            <div class="md:w-4/5 px-4 md:px-16 mx-auto md:pt-12 my-12">
                <h1 class="leading-lf font-black text-3xl md:text-6xl">
                    #Sensor@RefS</h1>
                <h2 class="leading-normal text-base md:text-xl mt-6 opacity-75 md:px-10">{i18n.t('campaign:refs')}</h2>
            </div>
        </div>

        <div class="container mx-auto mb-48">
            <div class="container mx-auto text-center">
                <a href="mailto:Campaign03@Sensor.Community" class="bg-teal-500 text-center hover:bg-teal-700 hover:text-white mx-auto rounded-lg inline-block shadow px-8 py-6 text-white text-xl">
