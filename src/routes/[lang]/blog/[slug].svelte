	...
	<div class="w-full md:max-w-3xl mx-auto pt-20">
		...
		<div>
				<span class="text-base md:text-sm text-teal-500 font-bold">&lt;</span>
					<a href="{$locale}/blog" class="text-base md:text-sm text-teal-500 font-bold no-underline hover:underline">BACK TO BLOG</a>
					<h1 class="font-bold font-sans break-normal text-gray-900 pt-6 pb-2 text-3xl md:text-4xl">{post.title}</h1>
				<p class="text-sm md:text-base font-normal text-gray-600">{post.printDate} ~ {post.printReadingTime}</p>
		</div>
