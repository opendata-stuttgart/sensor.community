...
<footer class="bg-gray-200 mt-12">
    <div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:col-span-2 flex">
                            ...
                            <div class="mt-8 flex">
                                <a href="https://fosstodon.org/@SensorCommunity"
                                   class="text-gray-400 hover:text-gray-500">
                                    ...
                                    <svg class="w-5 mr-2" viewBox="0 0 216.4144 232.00976"
                                ...
                                <a href="https://github.com/opendata-stuttgart/"
                                   class="ml-6 text-gray-400 hover:text-gray-500">
                                    ...
                                    <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"
                                         xmlns="http://www.w3.org/2000/svg"
                                         height="19"
                                         width="19" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                         stroke-width="2">
