...
<div class="border-teal-500 border-t-8 z-50">
    ...
    <div class="bg-lf-bg relative z-20 border-b">
        <header class="container mx-auto">
            <nav class="flex items-center justify-between flex-wrap">
                <div class="flex items-center flex-no-shrink text-white m-2 md:m-0 md:mr-6">
                </div>

                <div class="main-nav trans hidden w-full block flex-grow md:flex md:items-center md:w-auto">
                    <div class="text-sm flex-1">
                        <div class="outline-none bg-purple-white rounded-full w-full border-0 relative">
                            <input class="trans trans-slow outline-none text-sm transition hover:bg-grey-light focus:bg-lf-teal focus:text-white focus:font-bold bg-purple-white rounded-full w-full md:w-5/6 xl:w-full border-0 p-3  ">
                        </div>
                    </div>
                    <div class="md:text-right md:flex md:items-center md:justify-end">

                        <a class="border-b md:border-none block py-3 md:py-0 md:inline-block hover:text-lf-teal text-sm text-grey-darker mx-2 px-2 cursor-pointer"
                           rel=prefetch
                        ...
                        <a href="https://forum.sensor.community"
                           class="border-b md:border-none block py-3 md:py-0 md:inline-block hover:text-lf-teal text-sm text-grey-darker mx-2 px-2 cursor-pointer">
                            <img src="icons/external-link.svg" alt="">
                            Forum</a>

                        <a class="order-b md:border-none block py-3 md:py-0 md:inline-block hover:text-lf-teal text-sm text-grey-darker mx-2 px-2 cursor-pointer"
                        ...
                        <a class="relative border-b md:border-none block py-3 md:py-0 md:inline-block hover:text-lf-teal text-sm text-grey-darker mx-2 px-2 "
                           class:selected="{segment === `/${locale}/blog` ? 'selected' : ''}"
    ...
    <nav class="relative bg-white border-b-2 border-gray-300 text-gray-700 z-50">
        <div class="container mx-auto flex justify-between">
            ...
            <ul class="flex text-gray-700">
                ...
                <li>
                    <a class="relative block py-6 px-2 lg:p-5 text-sm lg:text-base font-bold"
                       href="https://forum.sensor.community" target="_blank" rel="noopener nofollow noreferrer">
                        Forum
                    </a>
                </li>
                <li><a class="relative block py-6 px-2 lg:p-5 text-sm lg:text-base font-bold"
