						...
						<div class="container mx-auto w-full flex flex-wrap justify-between mx-2">
							...
							<ul class="px-4 w-full sm:w-1/2 lg:w-1/4 border-white pb-6 pt-6 lg:pt-3">
								...
								<p class="text-white text-sm">Find all information about the project on Github, like our
									protocolls, additional instructions,...</p>
								<div class="flex items-center py-3">
									<svg class="h-6 pr-3 fill-current text-white"
										 xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
										<path d="M20 10a10 10 0 1 1-20 0 10 10 0 0 1 20 0zm-2 0a8 8 0 1 0-16 0 8 8 0 0 0 16 0zm-8 2H5V8h5V5l5 5-5 5v-3z"/>
...
<!--				<li>-->
<!--					<a class="relative block py-6 px-2 lg:p-5 text-sm lg:text-base font-bold"-->
<!--					   href="https://fosstodon.org/@SensorCommunity" target="_blank" rel="noopener nofollow noreferrer">-->
<!--						<img src="icons/mastodon.svg" width='21px' height="21px"-->
