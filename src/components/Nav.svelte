...
<!--                   rel=prefetch-->
<!--                   class:selected="{segment === `/{lang}/blog` ? 'selected' : ''}"-->
<!--                   href='{lang}/blog'>{i18n.t('nav:blog')}</a>-->
...
<!--                        {#each [lang] as item}-->
<!--                            <option class:selected={lang.includes(item)}-->
<!--                                    href={item}{`/{lang}`}-->
<!--                                    on:click={() => (lang = item)}>-->
<!--                                {item}-->
<!--                            </option>-->
...
<div class="relative bg-white border-b-2 border-gray-300 text-gray-700 z-50">
  <div class="container mx-auto flex justify-between">
    ...
    <ul class="flex text-gray-700">
      ...
      <li><a class="relative block py-6 px-2 lg:p-5 text-sm lg:text-base font-bold"
             class:selected="{segment === `/{lang}` ? 'selected' : ''}"
             href='{lang}/sensors/'>{i18n.t('nav:sensor')}</a></li>

      <!--            <li class="hoverable hover:bg-teal-500 hover:text-white">-->
      <!--                <a href='{lang}/docs' class:selected="{segment === `/{lang}/docs` ? 'selected' : ''}"-->
      <!--                   class="relative block py-6 px-4 lg:p-5 text-sm lg:text-base font-bold hover:bg-teal-500 hover:text-white">{i18n.t('nav:docs')}</a>-->
      ...
      <!--            </li>-->
      <!--            <li><a class="relative block py-6 px-2 lg:p-5 text-sm lg:text-base font-bold"-->
      <!--                   class:selected="{segment === `/{lang}/projects` ? 'selected' : ''}"-->
      <!--                   href='{lang}/projects'>{i18n.t('nav:projects')}</a></li>-->

      <li><a class="relative block py-6 px-2 lg:p-5 text-sm lg:text-base font-bold"
             href='https://forum.sensor.community'>{i18n.t('nav:forum')}</a></li>
      <li>
